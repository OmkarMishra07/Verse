...
// Premium iPod Hardware Palette
val iPodChassis = Color(0xFF2A2A2A) // Sleek metallic charcoal chassis start
val iPodChassisDark = Color(0xFF141414) // Metallic chassis gradient end
...
val iPodTextMuted = Color(0x99FFFFFF)
val iPodTextDim = Color(0x66FFFFFF)
